...
def main():
    ...
    product_parquet_path = "file:///home/takeo/pycharmproject/iphone-sales-analysis/data/product_data.parquet"
    ...
    # spark.sql("SELECT * FROM xyz.buyers_s8_not_iphone").show()
